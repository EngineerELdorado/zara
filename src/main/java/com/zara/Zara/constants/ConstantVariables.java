...
public class ConstantVariables {
    ...
    public static String TRANSACTION_MPESA_WITHRAWAL="MPESA_WITHDRAWAL";
    public static String TRANSACTION_AIRTEL_WITHRAWAL="AIRTELMONEY_WITHDRAWAL";
    public static String TRANSACTION_ORANGE_WITHRAWAL="ORANGEMONEY_WITHDRAWAL";
    public static String TRANSACTION_PESAPAY_TO_PAYPAL_CUSTOMER="PAYPAL_WITHDRAWAL";
    public static String TRANSACTION_PESAPAY_TO_BANK_CUSTOMER="BANK_WITHDRAWAL";
    ...
    public static String STRIPE_CLIENT_SECRET = "sk_live_bCpxaDbJjbK3AX0d3sDcPQh5";
    public static String STRIPE_CLIENT_SECRET_TEST = "sk_test_vPP5eARqBLor9jNuo8G3xkfC";
