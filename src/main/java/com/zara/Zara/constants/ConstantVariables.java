...
public class ConstantVariables {
    ...
    public static String TRANSACTION_MPESA_WITHRAWAL="MPESA_WITHRAWAL";
    public static String TRANSACTION_AIRTEL_WITHRAWAL="AIRTELMONEY_WITHRAWAL";
    public static String TRANSACTION_ORANGE_WITHRAWAL="ORANGEMONEY_WITHRAWAL";
