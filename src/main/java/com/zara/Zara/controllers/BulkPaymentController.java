...
import static com.zara.Zara.constants.ConstantVariables.TRANSACTION_ADMIN_TRANSFERT;
...
import static com.zara.Zara.constants.Responses.ACCOUNT_NOT_VERIFIED;
...
public class BulkPaymentController {
    ...
    Logger LOGGER = LogManager.getLogger(DepositController.class);
