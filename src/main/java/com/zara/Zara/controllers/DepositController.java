    ...
    public ResponseEntity<?>post(@RequestBody TransactionRequestBody request) throws UnsupportedEncodingException {
        ...
        if (agent==null){
            ...
            if (createdTransaction==null){
                ...
                sms1.setMessage(agent.getFullName()+ " vous venez de transferer "+request.getAmount()+"USD A "+customer.getFullName()+" via Setting. "+
                " type de transaction DEPOT DIRECT. votre solde actuel est "+updatedAgent.getBalance()+" USD. numero de transaction "+transaction.getTransactionNumber());
               ...
               Customer updatedCustomer = customerService.save(customer);
                ...
                sms2.setMessage(customer.getFullName()+ " vous venez de recevoir "+request.getAmount()+"USD venant du numero agent "+agent.getAgentNumber()+" "+agent.getFullName()+" via Setting. "+
